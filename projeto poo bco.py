...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo :
            ...
            print("Operação falhou! O valor informado é inválido ou insuficiente.")
            return False  
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        numero_saques =  len([transacao for transacao in self._historico.transacoes if transacao["tipo"] == Saque._name_])
...
class Historico:
    ...
    def adicionar_transacao(self, transacao):
     self._transacoes.append({"tipo": transacao._name_, "valor": transacao.valor})
...
def recuperar_conta_cliente(cliente):
    ...
    if len(cliente.contas) == 1:
        ...
        print("Cliente possui mais de uma conta. Não foi possível recuperar a conta.")
    return None
